...
permalink: /kubernetes/deploy-kops
title:  "Kops"
...
mem : 1
```
![alt text](../../../../images/kops/1-setup.png "Instância EC2")
...
![alt text](../../../../images/kops/3-setup.png "Funções")

  Selecione a opção EC2

![alt text](../../../../images/kops/4-setup.png "Funções")

  Aplique todas as permissões abaixo na Role.

![alt text](../../../../images/kops/5-setup.png "Permissões")
...
![alt text](../../../../images/kops/1-route53.png "Route 53")  
...
![alt text](../../../../images/kops/1-s3.png "S3")
...
![alt text](../../../../images/kops/1-kops.png "Kops")
...
![alt text](../../../../images/kops/2-kops.png "Kops")

### 4.2) Validando Cluster

![alt text](../../../../images/kops/3-kops.png "Kops")
...
![alt text](../../../../images/kops/4-kops.png "Kops")

Após aguardar os 10 minutos, rode novamente o comando.

![alt text](../../../../images/kops/5-kops.png "Kops")
...
![alt text](../../../../images/kops/7-kops.png "Kops")
...
![alt text](../../../../images/kops/15-kops.png "Update Cluster")
...
![alt text](../../../../images/kops/8-kops.png "Kops")
...
![alt text](../../../../images/kops/9-kops.png "Kops")

![alt text](../../../../images/kops/10-kops.png "Kops")

Esse endereço é provisionado dinâmicamente pelo LoadBalancer do AWS.

![alt text](../../../../images/kops/11-kops.png "Kops")
...
![alt text](../../../../images/kops/12-kops.png "DNS")

![alt text](../../../../images/kops/13-kops.png "DNS")

Após adicionar a entrada DNS podemos chamar a aplicação por um nome mais agradável.

![alt text](../../../../images/kops/14-kops.png "Nginx")
...
![alt text](../../../../images/kops/17-kops.png "LoadBalancer Ingress")
...
![alt text](../../../../images/kops/7-route53.png "Route53")

Crie as 2 entradas ( **nginx1** e **nginx2** ), conforme mostra a imagem abaixo.

![alt text](../../../../images/kops/8-route53.png "Route53")

### 6.2.2.8) Acessando Virtual Hosts

![alt text](../../../../images/kops/1-nginx.png "Nginx1")
![alt text](../../../../images/kops/2-nginx.png "Nginx2")
...
![alt text](../../../../images/kops/3-nginx.png "Nginx")

Ao acessar o browser ...

![alt text](../../../../images/kops/4-nginx.png "Nginx")
...
![alt text](../../../../images/kops/16-kops.png "Delete Cluster")
